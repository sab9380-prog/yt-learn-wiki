...
analyzed: 2026-06-29
category: 일반학습
tags: ["지식 그래프(Knowledge Graph)", "갓노드(God Node)", "라이덴 커뮤니티 탐지 알고리즘", "트리시터(Tree-sitter) 로컬 파싱", "신뢰도 태그(추출됨/추론됨/모호함)", "MCP 서버 연동"]
status: active
---
...
## 🔗 연결
- 카테고리: [[_category-일반학습]]
- 핵심 개념: [[지식 그래프]] · [[갓노드]] · [[라이덴 커뮤니티 탐지 알고리즘]] · [[트리시터]] · [[신뢰도 태그]] · [[MCP 서버 연동]]
